            ...
            pub mod sequence_search {
                ...
                impl ::core::fmt::Debug for Strand {
                    fn fmt(
                        ...
                        match self {
                            Strand::Plus => f.debug_tuple("Strand::Plus").finish(),
                            Strand::Minus => f.debug_tuple("Strand::Minus").finish(),
                        }
                    }
                }
                impl Strand {
                    #[doc(hidden)]
                    pub unsafe fn _lift(val: u8) -> Strand {
                        if !cfg!(debug_assertions) {
                            return ::core::mem::transmute(val);
                        }
                        match val {
                ...
                impl ::core::fmt::Debug for BlastnScoring {
                    fn fmt(
                        &self,
                        f: &mut ::core::fmt::Formatter<'_>,
                    ) -> ::core::fmt::Result {
                        f.debug_struct("BlastnScoring")
                            .field("match-reward", &self.match_reward)
                            .field("mismatch-penalty", &self.mismatch_penalty)
                            .field("gap-open", &self.gap_open)
                            .field("gap-extend", &self.gap_extend)
                            .field("search-both-strands", &self.search_both_strands)
                            .finish()
                    }
                }
                ...
                pub struct BlastpScoring {
                    pub matrix: _rt::String,
                    pub gap_open: i32,
                    pub gap_extend: i32,
                }
                impl ::core::fmt::Debug for BlastpScoring {
                    fn fmt(
                        &self,
                        f: &mut ::core::fmt::Formatter<'_>,
                    ) -> ::core::fmt::Result {
                        f.debug_struct("BlastpScoring")
                ...
                impl ::core::fmt::Debug for Scoring {
                    fn fmt(
                        &self,
                        f: &mut ::core::fmt::Formatter<'_>,
                    ) -> ::core::fmt::Result {
                        match self {
                            Scoring::BlastnDefault => {
                                f.debug_tuple("Scoring::BlastnDefault").finish()
                            }
                            Scoring::Blastn(e) => {
                                f.debug_tuple("Scoring::Blastn").field(e).finish()
                            }
                            Scoring::BlastpDefault => {
                                f.debug_tuple("Scoring::BlastpDefault").finish()
                            }
                            Scoring::Blastp(e) => {
                                f.debug_tuple("Scoring::Blastp").field(e).finish()
                            }
                        }
                    }
                }
                ...
                impl ::core::fmt::Debug for SearchOptions {
                    fn fmt(
                        ...
                        f.debug_struct("SearchOptions")
                            .field("evalue-max", &self.evalue_max)
                            .field("max-target-seqs", &self.max_target_seqs)
                            .field("min-identity", &self.min_identity)
                            .field("query-keys", &self.query_keys)
                            .field("subject-keys", &self.subject_keys)
                ...
                #[derive(Clone)]
                pub struct Hit {
                    pub query_key: _rt::String,
                    pub subject_key: _rt::String,
                    pub query_start: u32,
                    pub query_end: u32,
                ...
                impl ::core::fmt::Debug for Hit {
                    fn fmt(
                        ...
                        f.debug_struct("Hit")
                            ...
                            .field("subject-key", &self.subject_key)
                            .field("query-start", &self.query_start)
                            .field("query-end", &self.query_end)
                            .field("subject-start", &self.subject_start)
                            .field("subject-end", &self.subject_end)
                            .field("strand", &self.strand)
                            .field("identity-count", &self.identity_count)
                            .field("alignment-length", &self.alignment_length)
                            .field("percent-identity", &self.percent_identity)
                            .field("bit-score", &self.bit_score)
                            .field("raw-score", &self.raw_score)
                            .field("evalue", &self.evalue)
                            .finish()
                    }
                }
                ...
                pub enum SearchError {
                    EmptyQueries,
                    EmptySubjects,
                    InvalidSequence(_rt::String),
                    InvalidScoring(_rt::String),
                    AlignmentFailed(_rt::String),
                }
                impl ::core::fmt::Debug for SearchError {
                    fn fmt(
                        ...
                        match self {
                            SearchError::EmptyQueries => {
                                f.debug_tuple("SearchError::EmptyQueries").finish()
                            }
                            SearchError::EmptySubjects => {
                                f.debug_tuple("SearchError::EmptySubjects").finish()
                            }
                            SearchError::InvalidSequence(e) => {
                                f.debug_tuple("SearchError::InvalidSequence")
                                    .field(e)
                                    .finish()
                            }
                            SearchError::InvalidScoring(e) => {
                                f.debug_tuple("SearchError::InvalidScoring")
                                    .field(e)
                                    .finish()
                            }
                            SearchError::AlignmentFailed(e) => {
                                f.debug_tuple("SearchError::AlignmentFailed")
                                    .field(e)
                                    .finish()
                            }
                        }
                ...
                pub unsafe fn _export_search_cabi<T: Guest>(arg0: *mut u8) -> *mut u8 {
                    ...
                    let v29 = match l18 {
                        ...
                        1 => {
                            let e29 = {
                                ...
                                BlastnScoring {
                                    match_reward: l19,
                                    mismatch_penalty: l20,
                                    gap_open: l21,
                                    gap_extend: l22,
                                    search_both_strands: _rt::bool_lift(l23 as u8),
                                }
                            };
                            Scoring::Blastn(e29)
                        }
                        2 => Scoring::BlastpDefault,
                        n => {
                            debug_assert_eq!(n, 3, "invalid enum discriminant");
                            let e29 = {
                                let l24 = *arg0
                                ...
                                let l28 = *arg0
                                    ...
                                    .cast::<i32>();
                                BlastpScoring {
                                    matrix: _rt::string_lift(bytes26),
                                    gap_open: l27,
                                    gap_extend: l28,
                                }
                            };
                    ...
                    let result54 = T::search(
                        result8,
                        result17,
                        v29,
                        SearchOptions {
                            evalue_max: match l30 {
                                0 => None,
                                1 => {
                                    let e = {
                                        let l31 = *arg0
                            ...
                            max_target_seqs: match l32 {
                                0 => None,
                                1 => {
                                    let e = {
                                        let l33 = *arg0
                                            .add(36 + 6 * ::core::mem::size_of::<*const u8>())
                                            .cast::<i32>();
                                        l33 as u32
                                    };
                                    Some(e)
                        ...
                        Ok(e) => {
                            *ptr55.add(0).cast::<u8>() = (0i32) as u8;
                            ...
                            for (i, e) in vec59.into_iter().enumerate() {
                                ...
                                {
                                    let Hit {
                                        query_key: query_key56,
                                        subject_key: subject_key56,
                                        query_start: query_start56,
                                        query_end: query_end56,
                                        subject_start: subject_start56,
                                        subject_end: subject_end56,
                                        strand: strand56,
                                        identity_count: identity_count56,
                                        alignment_length: alignment_length56,
                                        percent_identity: percent_identity56,
                                        bit_score: bit_score56,
                                        raw_score: raw_score56,
                                        evalue: evalue56,
                                    } = e;
                                    let vec57 = (query_key56.into_bytes()).into_boxed_slice();
                                    let ptr57 = vec57.as_ptr().cast::<u8>();
                                    let len57 = vec57.len();
                                    ::core::mem::forget(vec57);
                                    *base
                                        ...
                                        .cast::<usize>() = len57;
                                    *base.add(0).cast::<*mut u8>() = ptr57.cast_mut();
                                    let vec58 = (subject_key56.into_bytes()).into_boxed_slice();
                                    ...
                                    *base
                                        .add(4 * ::core::mem::size_of::<*const u8>())
                                        .cast::<i32>() = _rt::as_i32(query_start56);
                                    *base
                                        .add(4 + 4 * ::core::mem::size_of::<*const u8>())
                                        .cast::<i32>() = _rt::as_i32(query_end56);
                                    *base
                                        .add(8 + 4 * ::core::mem::size_of::<*const u8>())
                                        .cast::<i32>() = _rt::as_i32(subject_start56);
                                    *base
                                        .add(12 + 4 * ::core::mem::size_of::<*const u8>())
                                        .cast::<i32>() = _rt::as_i32(subject_end56);
                                    *base
                                        .add(16 + 4 * ::core::mem::size_of::<*const u8>())
                                        .cast::<u8>() = (strand56.clone() as i32) as u8;
                                    *base
                                        .add(20 + 4 * ::core::mem::size_of::<*const u8>())
                                        .cast::<i32>() = _rt::as_i32(identity_count56);
                                    *base
                                        .add(24 + 4 * ::core::mem::size_of::<*const u8>())
                                        .cast::<i32>() = _rt::as_i32(alignment_length56);
                                    *base
                                        .add(32 + 4 * ::core::mem::size_of::<*const u8>())
                                        .cast::<f64>() = _rt::as_f64(percent_identity56);
                                    *base
                                        .add(40 + 4 * ::core::mem::size_of::<*const u8>())
                                        .cast::<f64>() = _rt::as_f64(bit_score56);
                                    *base
                                        .add(48 + 4 * ::core::mem::size_of::<*const u8>())
                                        .cast::<f64>() = _rt::as_f64(raw_score56);
                                    *base
                                        .add(56 + 4 * ::core::mem::size_of::<*const u8>())
                                        .cast::<f64>() = _rt::as_f64(evalue56);
                                }
                            }
                            *ptr55
                                .add(2 * ::core::mem::size_of::<*const u8>())
                ...
                pub unsafe fn __post_return_search<T: Guest>(arg0: *mut u8) {
                    ...
                    match l0 {
                        0 => {
                            ...
                            _rt::cabi_dealloc(
                                base7,
                                len7 * (64 + 4 * ::core::mem::size_of::<*const u8>()),
                                8,
                            );
                        }
                        _ => {
                ...
                pub trait Guest {
                    ...
                    fn search(
                        queries: _rt::Vec<Sequence>,
                        subjects: _rt::Vec<Sequence>,
                        scoring: Scoring,
                        options: SearchOptions,
                    ) -> Result<_rt::Vec<Hit>, SearchError>;
                }
                #[doc(hidden)]
                macro_rules! __export_tegmentum_bio_sequence_search_0_1_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[unsafe (export_name =
                        "tegmentum:bio/sequence-search@0.1.0#search")] unsafe extern "C"
                        fn export_search(arg0 : * mut u8,) -> * mut u8 { unsafe {
                        $($path_to_types)*:: _export_search_cabi::<$ty > (arg0) } }
                        #[unsafe (export_name =
                        "cabi_post_tegmentum:bio/sequence-search@0.1.0#search")] unsafe
                        extern "C" fn _post_return_search(arg0 : * mut u8,) { unsafe {
                        $($path_to_types)*:: __post_return_search::<$ty > (arg0) } } };
                    };
                }
                #[doc(hidden)]
                pub(crate) use __export_tegmentum_bio_sequence_search_0_1_0_cabi;
                #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                struct _RetArea(
                    [::core::mem::MaybeUninit<
...
macro_rules! __export_blast_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        ...
        exports::tegmentum::bio::sequence_search::__export_tegmentum_bio_sequence_search_0_1_0_cabi!($ty
        with_types_in $($path_to_types_root)*::
        exports::tegmentum::bio::sequence_search);
    };
}
#[doc(inline)]
...
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 6602] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xce2\x01A\x02\x01A%\x01\
...
/callback-dispatch@4.0.0\x05\x19\x01B\x1a\x01r\x02\x03keys\x04datas\x04\0\x08seq\
uence\x03\0\0\x01m\x02\x04plus\x05minus\x04\0\x06strand\x03\0\x02\x01r\x05\x0cma\
tch-rewardz\x10mismatch-penaltyz\x08gap-openz\x0agap-extendz\x13search-both-stra\
nds\x7f\x04\0\x0eblastn-scoring\x03\0\x04\x01r\x03\x06matrixs\x08gap-openz\x0aga\
p-extendz\x04\0\x0eblastp-scoring\x03\0\x06\x01q\x04\x0eblastn-default\0\0\x06bl\
astn\x01\x05\0\x0eblastp-default\0\0\x06blastp\x01\x07\0\x04\0\x07scoring\x03\0\x08\
\x01ku\x01ky\x01ps\x01k\x0c\x01ks\x01r\x06\x0aevalue-max\x0a\x0fmax-target-seqs\x0b\
\x0cmin-identity\x0a\x0aquery-keys\x0d\x0csubject-keys\x0d\x06strand\x0e\x04\0\x0e\
search-options\x03\0\x0f\x01r\x0d\x09query-keys\x0bsubject-keys\x0bquery-starty\x09\
query-endy\x0dsubject-starty\x0bsubject-endy\x06strand\x03\x0eidentity-county\x10\
alignment-lengthy\x10percent-identityu\x09bit-scoreu\x09raw-scoreu\x06evalueu\x04\
\0\x03hit\x03\0\x11\x01q\x05\x0dempty-queries\0\0\x0eempty-subjects\0\0\x10inval\
id-sequence\x01s\0\x0finvalid-scoring\x01s\0\x10alignment-failed\x01s\0\x04\0\x0c\
search-error\x03\0\x13\x01p\x01\x01p\x12\x01j\x01\x16\x01\x14\x01@\x04\x07querie\
s\x15\x08subjects\x15\x07scoring\x09\x07options\x10\0\x17\x04\0\x06search\x01\x18\
\x04\0#tegmentum:bio/sequence-search@0.1.0\x05\x1a\x04\0\x19tegmentum:bio/blast@\
0.1.0\x04\0\x0b\x0b\x01\0\x05blast\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\
