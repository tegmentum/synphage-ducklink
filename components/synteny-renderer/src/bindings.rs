    ...
    pub mod tegmentum {
        pub mod bio {
            ...
            pub mod synteny_renderer {
                ...
                pub struct Feature {
                    pub track_id: _rt::String,
                    pub feature_id: _rt::String,
                    pub start_position: u32,
                    pub end_position: u32,
                    pub strand: i8,
                    pub colour: Option<_rt::String>,
                ...
                impl ::core::fmt::Debug for Feature {
                    fn fmt(
                        ...
                        f.debug_struct("Feature")
                            .field("track-id", &self.track_id)
                            .field("feature-id", &self.feature_id)
                ...
                #[derive(Clone)]
                pub struct Link {
                    pub query_track: _rt::String,
                    pub query_feature: _rt::String,
                    pub subject_track: _rt::String,
                    pub subject_feature: _rt::String,
                    pub identity: f64,
                    pub colour: Option<_rt::String>,
                }
                impl ::core::fmt::Debug for Link {
                    fn fmt(
                        ...
                        f.debug_struct("Link")
                            .field("query-track", &self.query_track)
                            .field("query-feature", &self.query_feature)
                            .field("subject-track", &self.subject_track)
                            .field("subject-feature", &self.subject_feature)
                ...
                pub enum RenderError {
                    InvalidModel(_rt::String),
                    EmptyInput,
                }
                impl ::core::fmt::Debug for RenderError {
                    fn fmt(
                        &self,
                        f: &mut ::core::fmt::Formatter<'_>,
                    ) -> ::core::fmt::Result {
                        match self {
                            RenderError::InvalidModel(e) => {
                                f.debug_tuple("RenderError::InvalidModel").field(e).finish()
                            }
                            RenderError::EmptyInput => {
                                f.debug_tuple("RenderError::EmptyInput").finish()
                            }
                        }
                    }
                }
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_render_svg_cabi<T: Guest>(
                    arg0: *mut u8,
                    arg1: usize,
                    arg2: *mut u8,
                    arg3: usize,
                    ...
                    for i in 0..len7 {
                        ...
                        let e7 = {
                            ...
                            let l6 = *base
                                ...
                                .cast::<i32>();
                            Track {
                                track_id: _rt::string_lift(bytes2),
                                label: _rt::string_lift(bytes5),
                                length: l6 as u32,
                            }
                        };
                        result7.push(e7);
                    ...
                    for i in 0..len25 {
                        ...
                        let e25 = {
                            ...
                            Feature {
                                track_id: _rt::string_lift(bytes10),
                                feature_id: _rt::string_lift(bytes13),
                                start_position: l14 as u32,
                                end_position: l15 as u32,
                                strand: l16 as i8,
                                colour: match l17 {
                                    0 => None,
                                    1 => {
                    ...
                    _rt::cabi_dealloc(
                        base25,
                        len25 * (8 + 11 * ::core::mem::size_of::<*const u8>()),
                        ::core::mem::size_of::<*const u8>(),
                    );
                    let base43 = arg4;
                    let len43 = arg5;
                    ...
                    for i in 0..len43 {
                        ...
                        let e43 = {
                            ...
                            Link {
                                query_track: _rt::string_lift(bytes28),
                                query_feature: _rt::string_lift(bytes31),
                                subject_track: _rt::string_lift(bytes34),
                                subject_feature: _rt::string_lift(bytes37),
                                identity: l38,
                                colour: match l39 {
                                    0 => None,
                                    1 => {
                    ...
                    _rt::cabi_dealloc(
                        base43,
                        len43 * (16 + 10 * ::core::mem::size_of::<*const u8>()),
                        8,
                    );
                    let result44 = T::render_svg(result7, result25, result43);
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn __post_return_render_svg<T: Guest>(arg0: *mut u8) {
                    let l0 = i32::from(*arg0.add(0).cast::<u8>());
                    match l0 {
                        0 => {
                            let l1 = *arg0
                ...
                pub trait Guest {
                    fn render_svg(
                        tracks: _rt::Vec<Track>,
                        features: _rt::Vec<Feature>,
                        links: _rt::Vec<Link>,
                    ) -> Result<_rt::Vec<u8>, RenderError>;
                }
                #[doc(hidden)]
                macro_rules! __export_tegmentum_bio_synteny_renderer_0_1_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[unsafe (export_name =
                        "tegmentum:bio/synteny-renderer@0.1.0#render-svg")] unsafe extern
                        "C" fn export_render_svg(arg0 : * mut u8, arg1 : usize, arg2 : *
                        mut u8, arg3 : usize, arg4 : * mut u8, arg5 : usize,) -> * mut u8
                        { unsafe { $($path_to_types)*:: _export_render_svg_cabi::<$ty >
                        (arg0, arg1, arg2, arg3, arg4, arg5) } } #[unsafe (export_name =
                        "cabi_post_tegmentum:bio/synteny-renderer@0.1.0#render-svg")]
                        unsafe extern "C" fn _post_return_render_svg(arg0 : * mut u8,) {
                        unsafe { $($path_to_types)*:: __post_return_render_svg::<$ty >
                        (arg0) } } };
                    };
                }
                #[doc(hidden)]
                pub(crate) use __export_tegmentum_bio_synteny_renderer_0_1_0_cabi;
                #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                struct _RetArea(
                    [::core::mem::MaybeUninit<
...
macro_rules! __export_synteny_renderer_ducklink_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        ...
        exports::tegmentum::bio::synteny_renderer::__export_tegmentum_bio_synteny_renderer_0_1_0_cabi!($ty
        with_types_in $($path_to_types_root)*::
        exports::tegmentum::bio::synteny_renderer);
    };
}
#[doc(inline)]
...
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 6236] = *b"\
...
/callback-dispatch@4.0.0\x05\x19\x01B\x10\x01r\x03\x08track-ids\x05labels\x06len\
gthy\x04\0\x05track\x03\0\0\x01ks\x01r\x07\x08track-ids\x0afeature-ids\x0estart-\
positiony\x0cend-positiony\x06strand~\x06colour\x02\x05label\x02\x04\0\x07featur\
e\x03\0\x03\x01r\x06\x0bquery-tracks\x0dquery-features\x0dsubject-tracks\x0fsubj\
ect-features\x08identityu\x06colour\x02\x04\0\x04link\x03\0\x05\x01q\x02\x0dinva\
lid-model\x01s\0\x0bempty-input\0\0\x04\0\x0crender-error\x03\0\x07\x01p\x01\x01\
p\x04\x01p\x06\x01p}\x01j\x01\x0c\x01\x08\x01@\x03\x06tracks\x09\x08features\x0a\
\x05links\x0b\0\x0d\x04\0\x0arender-svg\x01\x0e\x04\0$tegmentum:bio/synteny-rend\
erer@0.1.0\x05\x1a\x04\0-tegmentum:bio/synteny-renderer-ducklink@0.1.0\x04\0\x0b\
\x1f\x01\0\x19synteny-renderer-ducklink\x03\0\0\0G\x09producers\x01\x0cprocessed\
