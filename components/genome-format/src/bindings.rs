...
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 5847] = *b"\
...
/callback-dispatch@4.0.0\x05\x19\x04\0*tegmentum:bio/genome-format-ducklink@0.1.\
0\x04\0\x0b\x1c\x01\0\x16genome-format-ducklink\x03\0\0\0G\x09producers\x01\x0cp\
